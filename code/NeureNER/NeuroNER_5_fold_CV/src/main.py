...
def load_parameters(parameters_filepath, arguments={}, verbose=True):
    ...
    '''
    parameters = {'pretrained_model_folder':None,
    ...
    if parameters['use_pretrained_model']:
        pretraining_parameters = load_parameters(parameters_filepath=os.path.join(parameters['pretrained_model_folder'], 'parameters_modified.ini'), verbose=False)[0]
...
def parse_arguments(arguments=None):
    ...
    parser.add_argument('--parameters_filepath', required=False, default=os.path.join('.','parameters_modified.ini'), help='The parameters file')
